...
module.exports = generators.Base.extend({
    ...
    prompting: function () {
        return this.prompt([{
            type    : 'input',
            name    : 'component_name',
            message : 'Component folder name? [dash style]',
            store   : true,
            default : this.component_name
        }, {
            type    : 'input',
            name    : 'component_location',
            message : 'Where do you want put your component folder?',
            store   : true,
    ...
    writing: function () {
        ...
        this.fs.copyTpl(
            ...
            this.destinationPath(this.component_location+'/'+ this.component_name + '/'+ this.component_name +'.component.scss')
        );
    }
});
